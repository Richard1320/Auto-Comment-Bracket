...
describe('Auto Comment Bracket', function() {
  describe('Test single file', function() {
    ...
    it('should return overwritten file with applied comments', function (done) {
      ...
      let command = 'node ./dist/index.js ' + testPath;
    ...
    it('should return overwritten file back to its original state', function (done) {
      ...
      let command = 'node ./dist/index.js ' + testPath + ' -u';
      runCommandAndtestPath(done,command,testPath,compareFile,outputFile);
    });
    ...
    it('should return a new file with applied comments', function (done) {
      ...
      let compareFile = './test/single_file/file_has_comments.scss';
      let command = 'node ./dist/index.js ' + testPath + ' -o ' + outputFile;
      runCommandAndtestPath(done,command,testPath,compareFile,outputFile);
    });
    ...
    it('should return a new file back to its original state', function (done) {
      ...
      let outputFile  = './test/single_file/file_output.scss';
      let compareFile = './test/single_file/file_no_comments.scss';
      let command = 'node ./dist/index.js ' + testPath + ' -u -o ' + outputFile;
      runCommandAndtestPath(done,command,testPath,compareFile,outputFile);
    });
  }); // End file test
  ...
  describe('Test directory loop', function() {
    ...
    it('should return overwritten file with applied comments', function (done) {
      ...
      let command = 'node ./dist/index.js ' + testPath + ' -d';
      runCommandAndtestPath(done,command,testPath,compareFile,outputFile);
    });
    ...
    it('should return overwritten file back to its original state', function (done) {
      ...
      let command = 'node ./dist/index.js ' + testPath + ' -d -u';
      runCommandAndtestPath(done,command,testPath,compareFile,outputFile);
    });
    ...
    it('should return a new file with applied comments', function (done) {
      ...
      let compareFile = './test/directory_loop/has_comments/_print.scss';
      let command = 'node ./dist/index.js ' + testPath + ' -d -o ' + outputPath;
      runCommandAndtestPath(done,command,testPath,compareFile,outputFile);
    });
    ...
    it('should return a new file back to its original state', function (done) {
      ...
      let outputPath  = './test/directory_loop/dist/';
      let compareFile = './test/directory_loop/no_comments/_print.scss';
      let command = 'node ./dist/index.js ' + testPath + ' -d -u -o ' + outputPath;
      runCommandAndtestPath(done,command,testPath,compareFile,outputFile);
    });
  });
  ...
  describe('Test recursive directory loop', function() {
    ...
    it('should return overwritten file with applied comments', function (done) {
      ...
      let command = 'node ./dist/index.js ' + testPath + ' -d -r';
      runCommandAndtestPath(done,command,testPath,compareFile,outputFile);
    });
    ...
    it('should return overwritten file back to its original state', function (done) {
      ...
      let command = 'node ./dist/index.js ' + testPath + ' -d -r -u';
      runCommandAndtestPath(done,command,testPath,compareFile,outputFile);
    });
    ...
    it('should return a new file with applied comments', function (done) {
      ...
      let outputPath  = './test/directory_loop/dist/';
      let compareFile = './test/directory_loop/has_comments/mixins/_buttons.scss';
      let command = 'node ./dist/index.js ' + testPath + ' -d -r -o ' + outputPath;
      runCommandAndtestPath(done,command,testPath,compareFile,outputFile);
    });
    ...
    it('should return a new file back to its original state', function (done) {
      ...
      let outputPath  = './test/directory_loop/dist/';
      let compareFile = './test/directory_loop/no_comments/mixins/_buttons.scss';
      let command = 'node ./dist/index.js ' + testPath + ' -d -r -u -o ' + outputPath;
      runCommandAndtestPath(done,command,testPath,compareFile,outputFile);
    });
  });
});
